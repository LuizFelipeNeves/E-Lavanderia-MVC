...
<html lang="pt-br">
  ...
  -->
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
			...
			<li class="active"><a href="<?php echo base_url('order_insert');?>"><i class="fa fa-plus-square"></i> <span>Inserir Pedido</span></a></li>
    ...
    <!-- /.sidebar -->
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-plus-square"></i> Inserir Pedido</a></li>
      </ol>
    </section>
    ...
    <div class="col-md-6">    
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Inserir Pedido</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="POST" action="<?= base_url('Order_insert/insertOrder') ?>">
              <div class="box-body">
